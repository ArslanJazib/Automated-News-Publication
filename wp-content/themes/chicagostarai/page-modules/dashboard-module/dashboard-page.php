    ...
    <div class="row dashboard-content g-xl-5 g-3 mb-5">
        <div class="col-lg-3 side-bar-nav">
            ...
            <div class="sidebar-mob">
                <?php
                include('/xampp/htdocs/Chicago-Star/wp-content/themes/chicagostarai/sidebar-template/sidebar-template.php');
                ?>
            </div>
        </div>
        <div class="col-lg-9">
            ...
            <div class="content-body">
                <form action="">
                    <?php get_template_part('/blocks-templates/instructions-template-block/instructions-template-block', 'page') ?>
                    <?php get_template_part('/blocks-templates/add-prompt-template-block/add-prompt-template-block', 'page') ?>
                    <?php get_template_part('/blocks-templates/add-prompt-template-block/add-prompt-template-block', 'page') ?>
                    <div class="btn-module mb-5">
                        <a href="" class="btn btn-dashboard">Add Prompt</a>
                    </div>
                </form>
            </div>
        </div>
